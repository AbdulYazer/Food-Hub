...
List<TranslatorModel> translatorModelFromJson(String str) => List<TranslatorModel>.from(json.decode(str).map((x) => TranslatorModel.fromJson(x)));

String translatorModelToJson(List<TranslatorModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
