...
HomePageResponse _$HomePageResponseFromJson(Map<String, dynamic> json) =>
    HomePageResponse(
      ...
      tableMenuList: (json['table_menu_list'] as List<dynamic>?)
          ?.map((e) => TableMenuLists.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
TableMenuLists _$TableMenuListsFromJson(Map<String, dynamic> json) =>
    TableMenuLists(
...
Map<String, dynamic> _$TableMenuListsToJson(TableMenuLists instance) =>
    <String, dynamic>{
